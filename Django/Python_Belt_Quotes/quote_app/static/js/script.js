function validateRegister() {
    var fname = document.forms["register"]["fname"].value, lname = document.forms["register"]["lname"].value, email = document.forms["register"]["email"].value, password = document.forms["register"]["password"].value, confirm = document.forms["register"]["confirm"].value;
    var errors = [];
    if (fname.length == 0) {
